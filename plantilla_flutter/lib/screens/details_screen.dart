          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [
                _PosterAndTitile(
                    movie:
                        peli), // tots els metodes reben per parametre una pelicula desde el provider
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  overflow: TextOverflow.ellipsis,
                  maxLines:
                      2, // cambiam els noms que venien definits per la seva variable de pelicula
                ),
                Row(
                  children: [
...
class _Overview extends StatelessWidget {
  ...
  const _Overview({Key? key, required this.movie})
      : super(
            key:
                key); // totes aquestes tenen definit el constructor per rebre una Movie
